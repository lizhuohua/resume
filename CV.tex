...
\cvitemwithcomment{\textsc{FFIChecker} (\faIcon[regular]{star}35)}{A Tool for Detecting Cross-Language Memory Management Issues in Rust}{\iconlink[\faGithub]{https://github.com/lizhuohua/rust-ffi-checker}}
...
\cvitemwithcomment{\textsc{MirChecker} (\faIcon[regular]{star}111)}{A Static Analysis and Bug Detection Tool for Rust programs}{\iconlink[\faGithub]{https://github.com/lizhuohua/rust-mir-checker}}
