...
\vspace*{-10mm}
\section{EDUCATION}
\cventry{Aug.2017--Oct.2022}{Ph.D. in Computer Science and Engineering}{The Chinese University of Hong Kong}{Hong Kong}{}{Advanced Networking and System Research Laboratory (ANSRLab)\\ Supervised by Prof. John C.S. Lui}
...
\cvitemwithcomment{\textsc{FFIChecker} (\faIcon[regular]{star}36)}{A Tool for Detecting Cross-Language Memory Management Issues in Rust}{\iconlink[\faGithub]{https://github.com/lizhuohua/rust-ffi-checker}}
...
\cvitemwithcomment{\textsc{MirChecker} (\faIcon[regular]{star}114)}{A Static Analysis and Bug Detection Tool for Rust programs}{\iconlink[\faGithub]{https://github.com/lizhuohua/rust-mir-checker}}
...
\cvitemwithcomment{linux-kernel-module-rust (\faIcon[regular]{star}632)}{A Framework for Secure Kernel Module Development in Rust}{\iconlink[\faGithub]{https://github.com/lizhuohua/linux-kernel-module-rust}}
...
\cvitemwithcomment{Reviewer}{IEEE/ACM Transactions on Networking, IEEE Transactions on Software Engineering}{}
...
\cvitem{}{Talent Class Top-Tier Scholarship Plan, Category A (10\%) for three times \hfill 2014--2016, \textbf{USTC}}
\cvitem{}{Second-class Scholarship for Outstanding Student (10\%) for two times \hfill 2015, 2016, \textbf{USTC}}
\cvitem{}{Third-class Scholarship for Outstanding Student (15\%) for two times \hfill 2013, 2014, \textbf{USTC}}
\cvitem{}{Excellent Student Cadre (3\%) \hfill 2015, \textbf{USTC}}
